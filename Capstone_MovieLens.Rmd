...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 1. The distribution of movie ratings in the dataset."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 2. No clear pattern in rating frequency/year."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 3. Average movie rating (score, not frequency) decreases slightly over time but inconsequentially."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 4. Slight, but relatively unimpactful, pattern in average movie ratings issued by month. Ratings are slightly higher during winter than summer which could be for various sociocultural reasons beyond this study."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 5. Highly skewed distribution of ratings per user which will likely add bias to predictive analyses."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 6. A pattern between movie age and rating received emerges but the data does not yield cultural/film-based evidence of why this may occur."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = "Figure 7. Similar to Figure 5, it is likely that distribution of ratings per genre will influence upcoming predictive analyses."}
...
Next, I examined various approaches to predicting the movie score as measured by RMSE. I began with predicing movie rating simply using the mean and then a vector near the mean (3.4). I create four subsequent models that account for varying biases such as that introduced by the movie, user, genre, or movie's age.


```{r, message=TRUE, results ='asis', warning = FALSE, echo=FALSE, fig.cap = "We can tell that the mean model is better than the model including any other number by creating a vector similar to, but not exactly the same as, the mean."}
...
```{r, message=TRUE, warning = FALSE, echo=FALSE, fig.cap = " "}
...
Next, we run the matrix factorization on the final_holdout_test dataset. 
...
Finally, I examine predicting movie rating with the XGBOOST technique. 
